...
from data import getDataRooms, getRooms, getAccesspoints, getTestData
...
fig.tight_layout()
plt.savefig("Plots/AvgSignalPrRoom.svg", bbox_inches = "tight") # 'tight' makes room for x-axis labels
plt.show()